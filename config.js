...
const defaultOwner = '22898751561';


// Check for the OWNERS environment variable; if not found, use the default
const ownervb = process.env.OWNERS || process.env.OWNER_NUMBER || '22898751561' ; // put your number here
...
global.pairingNumber = process.env.BOT_NUMBER || '22898751561' ;  // put your number here
global.SESSION_ID = process.env.SESSION_ID || '' ;  // put your session id here

global.mods = []
global.prems = []
global.allowed = ['22897810477', '923051391007']
